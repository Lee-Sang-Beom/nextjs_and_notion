...
export default function ExecutionContext() {
      ...
      <div className="lg:w-full md:pl-10 py-6">
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed mb-4">
              {`자바스크립트 코드를 실행시키면, 자바스크립트 엔진은 `}
              <strong>{`콜 스택(Call Stack)`}</strong>
              {`이라는 통에 `}
              <strong>전역 실행 컨텍스트</strong>
              {`를 담아요.`}
            </p>
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed mb-4">
              {`전역에서 함수 a를 실행시키면, `}
              <strong>{`함수 a의 실행 컨텍스트를 생성해 콜 스택에 담아요.`}</strong>
            </p>
            <p className="leading-relaxed">
              {`이 때, 콜 스택 안에는 `}
              <strong>{`가장 최근에 추가된 실행 컨텍스트(함수 a의 컨텍스트)만 활성화`}</strong>
              {`되게 됩니다.`}
            </p>
          </div>
        </div>
      ...
      <div className="lg:w-full md:pl-10 py-6 mb-8">
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">
              자바스크립트 엔진은 코드를 실행하면, 우선 전역 실행 컨텍스트를
              생성해 콜 스택에 넣습니다.
            </p>
          </div>
        </div>
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">
              그 후 전체 코드를 살펴보며, 선언할 식별자들이 있는지 찾아보고,
              있다면 먼저 선언해둡니다.
            </p>
          </div>
        </div>
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed mb-4">
              ...
              <strong>환경 레코드에 새로운 식별자를 기록</strong>합니다. 그리고,
              이 식별자는{" "}
              <strong>
                var로 선언한 변수이기 때문에 undefined로 값을 초기화
              </strong>
              합니다.
            </p>
      ...
      <div className="lg:w-full md:pl-10 py-6 mb-8">
        ...
        <div className="flex relative">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">
              이 때, 식별자는 초기화되지 않았기 때문에{" "}
              <strong>ReferenceError</strong>가 발생합니다.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="lg:w-full md:pl-10 py-6 mb-8">
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">
              자바스크립트의 함수는 변수에 담을 수 있습니다. 변수에 담긴 함수는
              변수 호이스팅처럼 동작합니다.
            </p>
          </div>
        </div>
            ...
            <div className="leading-relaxed text-base">
              <ul className="list-disc ml-7 text-sm text-slate-500 dark:text-slate-300 ">
                <li className="mb-1 text-left">
                  {`var 키워드로 선언된 식별자인 경우에는 `}
                  <strong>
                    값이 환경 레코드에 undefined로 초기화되어 저장되었기에,
                  </strong>
                  {` 호출 불가능하므로 TypeError가 발생합니다.`}
                </li>
                <li className="mb-1 text-left">
                  {`let/const 로 선언한 식별자인 경우에는 `}
                  <strong>값이 환경 레코드에 초기화되지 않았기 때문에,</strong>
      ...
      <div className="lg:w-full md:pl-10 py-6 mb-8">
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed mb-4">
              자바스크립트 엔진은 함수 선언문을 발견함과 동시에, 완성된 함수
              객체를 생성해 환경 레코드에 기록해둡니다.
            </p>
            <p className="leading-relaxed">
              이렇게, 함수 선언문으로 함수를 선언하는 경우에는,{" "}
              <strong>{`선언과 동시에 함수가 생성되어 선언 전에도 함수를 실행할 수 있다는 특징`}</strong>
              이 있습니다.
            </p>
          </div>
        </div>
      ...
      <div className="lg:w-full md:pl-10 py-6 mb-8">
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">
              이 때, 전역 실행 컨텍스트에 선언된{" "}
              <strong>{`isPerson=false, goTo2F()`}</strong>의 정보를 전역 실행
              컨텍스트의 환경 레코드에 담습니다.
            </p>
          </div>
        </div>
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed mb-4">
              이 때, 함수 {`goto2F`} 스코프 내에 선언되어있는 정보를 실행
              컨텍스트의 환경 레코드에 기록합니다.
            </p>
            <p className="leading-relaxed ">
              동시에, 자바스크립트 엔진은 새로 생성된 실행 컨텍스트에 바깥
              렉시컬 환경으로 돌아갈 수 있는 <strong>outer</strong>를
              남겨놓습니다.
            </p>
          </div>
        </div>
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">
              마찬가지로, 함수 {`goto3F`} 스코프 내에 선언되어있는 정보를 실행
              컨텍스트의 환경 레코드에 기록하고, outer를 함께 남겨놓습니다.
            </p>
          </div>
        </div>
        {/* 과정 4 */}
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed mb-4">
              <strong>{`console.log(pet)`}</strong>을 수행하면 같은 스코프 내에
              적합한 pet이라는 식별자가 있기 때문에, pet에 있는 cat이라는 값을
              바로 출력합니다.
            </p>
            <p className="leading-relaxed">
              <strong>{`console.log(isPerson)`}</strong>의 경우, 스코프 내에
              적합한 식별자가 없기 때문에 <strong>outer</strong>가 가리키는{" "}
              <strong>{`바깥 렉시컬 환경(상위 스코프)`}</strong>으로 이동하여,
              다시 isPerson이라는 식별자를 탐색합니다.
            </p>
          </div>
        </div>
        {/* 과정 5*/}
        <div className="flex relative">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed mb-4">
              함수 {`goto2F`}의 환경으로 이동하여, isPerson 식별자를 찾은 후,
              true를 출력합니다.
            </p>
            <p className="leading-relaxed mb-4">
              이 때, <strong>자바스크립트 엔진</strong>은 전역 실행 컨텍스트의
              isPerson 식별자가 저장된 위치까지 이동하여 파악하는 과정을
              거치지는 않습니다. 이렇게, 동일한 식별자로 인해 상위스코프에서
              선언한 식별자 값이 가려지는 현상을 <strong>변수 섀도잉</strong>
              이라고 합니다.
            </p>
            <p className="leading-relaxed">
              그리고, outer가 가리키는 렉시컬 환경으로 이동하면서, 식별자를
              결정할 때 활용하는 <strong>스코프의 연결리스트</strong>를{" "}
              <strong>스코프 체인</strong>이라고 합니다.
            </p>
          </div>
        </div>
      </div>
  ...
  const ExecutionContextKindsComponent = () => {
    return (
      <div className="my-16">
        <h1 className="text-lg font-bold title-font text-gray-900 pl-0 md:pl-2">
          🤔 실행 컨텍스트의 종류
        </h1>
        <div className="flex flex-wrap">
          <div className="p-12 py-6 md:w-1/2 flex flex-col items-start">
            ...
            <p className="leading-relaxed mb-4">
              전역 영역에 존재하는 코드에 해당하며, 함수 안에서 실행되는 코드가
              아니라면 모든 스크립트는 
              <strong>{`전역 컨텍스트(Global Context)`}</strong>에서 실행됩니다.
            </p>
            <p className="leading-relaxed mb-4">
              스택 구조를 가지는 형태로 실행 컨텍스트가 생성이 된 후,{" "}
              <strong>{`전역 객체(global object)로 window가 this로 할당`}</strong>
              된 다음, 콜 스택에 쌓이게 됩니다.
            </p>
            <p className="leading-relaxed mb-2">
              참고로, strict mode가 적용된 this의 default는{" "}
              <strong>undefined</strong>입니다.
            </p>
          </div>
          <div className="p-12 py-6 md:w-1/2 flex flex-col md:flex-none items-start">
            ...
            <p className="leading-relaxed mb-4">
              <strong>{`함수 컨텍스트(Functional Context)`}</strong>는 선언된
              함수가 호출이 될 때를 기점으로 생성이 되고, 함수의 모든 동작이
              완료되면 소멸됩니다.
            </p>
            <p className="leading-relaxed mb-2">
              각 함수들은 자신만의 Functional Context를 가지지만,{" "}
              <strong>함수가 호출되고 실행이 되어야만</strong> 콜 스택에
              쌓이게됩니다.
            </p>
          </div>
        </div>
            ...
            <div className="h-full">
              <div className="pl-6">
                ...
                <p className="leading-relaxed mb-2">
                  ...
                  <strong>환경 레코드</strong>
                  {`와 현재 호출된 함수가 선언될 당시의 LexicalEnvironment를 참조하는 `}
                  <strong>outer</strong>
                  {`를 담습니다.`}
                </p>
        ...
        <section className="text-gray-600 body-font">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-2">
                ...
                <p className="sm:w-full leading-relaxed text-base sm:pl-10 pl-0 mt-4 mb-1">
                  ...
                  {`는 복합적인 개념을 포함하고 있기 때문에, 이번 Section에서는 `}
                  <strong>개념을 환기할 수 있는 예시를 들어가며,</strong>
                  {` 실행 컨텍스트의 내용에 접근해 볼 거에요.`}
                </p>
          ...
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="flex flex-wrap sm:flex-row flex-col py-6">
              ...
              <p className="sm:w-full leading-relaxed text-base sm:pl-10 pl-0 mt-4 mb-1">
                {`- 해당 Section에서는 자바스크립트 코드의 실행에 따라 `}
                <strong>콜 스택</strong>
                {`이 어떻게 동작하는 지에 대한 예시를 들면서 환기할 예정이에요.`}
              </p>
              <p className="sm:w-full leading-relaxed text-base sm:pl-10 pl-0 mb-1">
              ...
              <p className="sm:w-full leading-relaxed text-base sm:pl-10 pl-0">
                ...
                {`라는 용어를 사용할텐데, 일단 `}
                <strong>
                  {`"실행 컨텍스트는 뭔지 잘 모르겠지만, 여기에는 환경 레코드와 Outer라는 게 들어가는구나!"`}{" "}
                </strong>
                {`라고 이해해주시면 되요!`}
              </p>
            </div>
            ...
            <div className="w-full">
              <div className="w-full px-4 mb-1 flex-col text-center justify-center">
                <Image
                  src={jsAndCallStackCode}
                  alt="Code Picture of callstack and js"
                  className="lg:w-full rounded-lg"
                />
                <Image
                  src={jsAndCallstack}
                  alt="Picture of callstack and js"
                  className="lg:w-full rounded-lg"
                />
              </div>
          ...
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="w-full">
              ...
              <div className="w-full mb-8 flex justify-center">
                <Image
                  src={variableHoistingAndEnvRecordEx}
                  alt="Code Picture of hoisting and variable(1)"
                  className="lg:w-full rounded-lg"
                />
              </div>

              {/* var 키워드 선언에 따른 변수 호이스팅 소개 */}
              <h1 className="text-lg font-bold title-font text-gray-900 my-3 pl-0 md:pl-2">
                💬 var 키워드로 선언된 변수 호이스팅과 환경 레코드
              </h1>
              <div className="w-full px-4 mb-1 flex-col text-center justify-center">
                <Image
                  src={jsAndHoistingVar}
                  alt="step Picture of hoisting and variable(1)"
                  className="lg:w-full rounded-lg"
                />
              </div>
              {/* step content */}
              ...
              <h1 className="text-lg font-bold title-font text-gray-900 my-3 pl-0 md:pl-2">
                💬 let, const 키워드로 선언된 변수 호이스팅과 환경 레코드
              </h1>
              <div className="w-full px-4 mb-1 flex-col text-center justify-center">
                <Image
                  src={jsAndHoistingLetConst}
                  alt="step Picture of hoisting and variable(2)"
                  className="lg:w-full rounded-lg"
                />
              </div>
              {/* step content */}
              ...
              <h1 className="text-lg font-bold title-font text-gray-900 my-3 pl-0 md:pl-2">
                💬 함수 표현식에 대한 호이스팅과 환경 레코드
              </h1>
              <div className="w-full px-4 mb-1 flex-col text-center justify-center">
                <Image
                  src={functionExpressionHoistingEx}
                  alt="Code Picture of hoisting functionExpression"
                  className="lg:w-full rounded-lg"
                />
                <Image
                  src={functionExpressionHoisting}
                  alt="step Picture of hoisting and functionExpression"
                  className="lg:w-full rounded-lg"
                />
              </div>
              {/* step content */}
              ...
              <h1 className="text-lg font-bold title-font text-gray-900 my-3 pl-0 md:pl-2">
                💬 함수 선언문에 대한 호이스팅과 환경 레코드
              </h1>
              <div className="w-full px-4 mb-1 flex-col text-center justify-center">
                <Image
                  src={functionDeclarationHoistingEx}
                  alt="Code Picture of hoisting functionExpression"
                  className="lg:w-full rounded-lg"
                />
                <Image
                  src={functionDeclarationHoisting}
                  alt="step Picture of hoisting and functionExpression"
                  className="lg:w-full rounded-lg"
                />
              </div>
          ...
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="flex flex-wrap sm:flex-row flex-col py-6">
              ...
              <p className="sm:w-full leading-relaxed text-base sm:pl-10 pl-0 mt-4 mb-1">
                {`- 위에서 배운 환경 레코드가 호이스팅과 관련이 되었다면, 지금부터 배울 `}
                <strong>{`Outer(Outer environment Reference)`}</strong>
                {`는 스코프 체인과 관련된 내용이에요.`}
              </p>
              <p className="sm:w-full leading-relaxed text-base sm:pl-10 pl-0 mb-1">
              ...
              <p className="sm:w-full leading-relaxed text-base sm:pl-10 pl-0">
                ...
                {`는 코드 블록, 함수 등을 실행하기 앞서 생성되는 특별한 객체로, 실행할 스코프 범위 안에 있는 변수와 함수를 프로퍼티로 저장하는 객체에요. 
            ...
            <div className="w-full">
              <div className="w-full px-4 mb-1 flex-col text-center justify-center">
                <Image
                  src={outerAndScopeChainCode}
                  alt="Code Picture of callstack and js"
                  className="lg:w-full rounded-lg"
                />
                <Image
                  src={outerAndScopeChainEx}
                  alt="Picture of callstack and js"
                  className="lg:w-full rounded-lg"
                />
              </div>
