            ...
            <Layout>
                ...
                <section className="text-gray-600 body-font overflow-hidden">
                    ...
                    <div className="container px-5 py-12 mx-auto">
                        ...
                        {/* 분류 */}
                        <div className="mb-12">
                            <h1 className="text-2xl font-bold title-font text-gray-900 mt-6 mb-2 ">스코프 체인</h1>
                            ...
                            <div className="flex flex-wrap -m-4">
                                <div className="p-4 lg:w-1/2 w-full">
                                    <div className="h-full bg-gray-100 dark:bg-gray-200 p-8 rounded">
                                        ...
                                        <p className="leading-relaxed mb-1 dark:text-slate-700">{`이 때, 해당 스코프에 식별자가 없으면, 해당 스코프를 포함하는 상위 스코프로 이동해 식별자를 찾아나가요.`}</p>  
